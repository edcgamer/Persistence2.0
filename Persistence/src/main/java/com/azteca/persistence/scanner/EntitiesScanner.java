package com.azteca.persistence.scanner;
 ...
 * @author Kincanek
 * 
 * Esta clase se usa para escanear todos los entities de determinado paquete, sin la necesidad de
 * declararlas en todos los persistenceunit
 */
public class EntitiesScanner implements ApplicationContextAware, PersistenceUnitPostProcessor {
    ...
    /**
     *
     * Realiza el scan de las entidades con Spring
     *
    ...
    /**
     *
     * Se asegura que solo se escaneen entidade validas
     *
     * reader.
     */
